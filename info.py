...
lazy_renamers = [int(lazrenamers) if id_pattern.search(lazrenamers) else lazrenamers for lazrenamers in environ.get('LAZY_RENAMERS', '@moviesaddaorg').split()]
...
URL = "https://moviesss-hd1d.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://moviesss-hd1d.onrender.com".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://moviesss-hd1d.onrender.com".format(FQDN)
else:
    URL = "https://moviesss-hd1d.onrender.com".format(FQDN)
BANNED_CHANNELS = list(set(int(x) for x in str(getenv("BANNED_CHANNELS", "-1001987654567")).split())) 
OWNER_USERNAME = "Jaiveer"
